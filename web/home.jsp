	...
	<nav class="navbar navbar-inverse navbar-fixed-top" id="my-navbar">
		<div class="container">
			<div class="navbar-header">
				...
				<a href="home.html" class="navbar-brand">PeopleTalk</a>
			</div><!--end header-->
		</div><!--end container-->
	</nav><!--end navbar-->	
	<div class="container">
				...
				<div class="col-lg-6">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="profile.html" method='post' data-toggle="validator" enctype='multipart/form-data'  class="form-horizontal">
